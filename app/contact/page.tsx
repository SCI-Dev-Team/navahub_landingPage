...
const faqs = [
  { q: "What is a Navathon?",                    a: "A Navathon is a hackathon organized by Save the Children focused on building tech solutions for real community challenges." },
  { q: "Do I need coding experience?",           a: "Not at all! We welcome designers, problem-solvers, community workers, and domain experts just as much as developers." },
  { q: "Are Navathons free to join?",            a: "Yes — all Navathons are completely free for participants. Some in-person events may provide meals and accommodation too." },
  { q: "Can I organize a Navathon?",             a: "Absolutely. Fill out the contact form with 'Organize a Navathon' as your subject and our team will be in touch." },
];
...
export default function ContactPage() {
  ...
  return (
    <>
      {/* Hero */}
      <section className="relative pt-28 pb-16 px-4 sm:px-6 lg:px-8 overflow-hidden bg-linear-to-b from-red-50 to-white">
